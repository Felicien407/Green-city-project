               ...
               <div className='w-3/6 h-3/4 flex flex-col items-center justify-evenly'>
                  ...
                  <div className='w-full h-[4em] flex items-center relative -top-[1em]'>
                     <div className='w-1/3 h-9/11 rounded-full flex items-center justify-center overflow-hidden ring-1 ring-gray-600'>
                        <div className='w-1/3 h-full bg-gray-200 active:bg-gray-400 flex items-center justify-center ring-1 ring-r-gray-400 text-3xl font-medium' onClick={decrement}> 
                           -
                        </div>
                        {/* Counting the users booking items */}
                        <div className='w-1/3 flex items-center justify-center'>{Counter}</div>
                        <div className='w-1/3 h-full bg-gray-200 active:bg-gray-400 flex items-center justify-center ring-1 ring-l-gray-400 text-3xl font-medium' onClick={increment}>
                           +
                        </div>
                     </div>
                  </div>
                  ...
                  <div className='w-full h-[7em]'>
                     <p className='relative -top[.6em] text-lg text-gray-600 font-medium left-[.9em]'>Descriptions</p>
